...
|-----------------|-----------------|---------------------|---------------------------------------------------------------------------------------------|
| 1               | 38              | February 19th, 2026 | [Documentation](https://github.com/vyuldashev/laravel-queue-rabbitmq/blob/master/README.md) |
...
```
composer require salesmessage/php-lib-rabbitmq:^1.38 --ignore-platform-reqs
```
