...
|-----------------|-----------------|------------------|---------------------------------------------------------------------------------------------|
| 1               | 49              | March 27th, 2026 | [Documentation](https://github.com/vyuldashev/laravel-queue-rabbitmq/blob/master/README.md) |
...
```
composer require salesmessage/php-lib-rabbitmq:^1.49 --ignore-platform-reqs
```
