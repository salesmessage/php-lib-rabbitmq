...
|-----------------|-----------------|-----------------|---------------------------------------------------------------------------------------------|
| 1               | 71              | September 25th, 2026 | [Documentation](https://github.com/vyuldashev/laravel-queue-rabbitmq/blob/master/README.md) |
...
```
composer require salesmessage/php-lib-rabbitmq:^1.71 --ignore-platform-reqs
```
