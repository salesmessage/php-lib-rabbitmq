...
|-----------------|-----------------|-----------------|---------------------------------------------------------------------------------------------|
| 1               | 70              | September 24th, 2026 | [Documentation](https://github.com/vyuldashev/laravel-queue-rabbitmq/blob/master/README.md) |
...
```
composer require salesmessage/php-lib-rabbitmq:^1.70 --ignore-platform-reqs
```
